...
- [`implementation-plan.md`](../build/implementation-plan.md) Phase 6 (governance-level enforcement) - link to this document; mark v0/v1/v2 as substages of the payment workstream.
...
- [`implementation-plan.md` § Phase 6](../build/implementation-plan.md) - governance-level enforcement phase
